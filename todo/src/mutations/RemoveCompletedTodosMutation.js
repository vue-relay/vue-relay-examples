...
import type {Todos_user} from 'relay/Todos_user.graphql';
type Todos = $NonMaybeType<$ElementType<Todos_user, 'todos'>>;
...
function sharedUpdater(
  ...
  const conn = ConnectionHandler.getConnection(userProxy, 'Todos_todos');
